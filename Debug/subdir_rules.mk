...
build-1876589361:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-1876589361-inproc

build-1876589361-inproc: ../I2C_port_for_bq27441.cfg
	@echo 'Building file: $<'
...
configPkg/linker.cmd: build-1876589361
configPkg/compiler.opt: build-1876589361
configPkg/: build-1876589361
